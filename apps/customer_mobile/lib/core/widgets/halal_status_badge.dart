...
///
/// Reuses the UI-803 token set (see the POS badge implementation); renders
/// only when the item holds a valid HALAL certification (`isHalal == true`
/// in the Menu & Product API contract).
