...
///
/// Semantic catalog tokens (draft / published / hidden / stop-list / halal)
/// are defined here and must be used instead of hardcoded colors in widgets.
abstract final class AppColors {
  ...
  // Catalog semantic tokens (UI-802 § Catalog Semantic Tokens)
  static const Color statusDraft = gray500;
  static const Color statusDraftContainer = gray200;
  static const Color statusPublished = success;
  static const Color statusPublishedContainer = successContainer;
  static const Color statusHidden = warning;
  static const Color statusHiddenContainer = warningContainer;
  static const Color statusStopList = error;
  static const Color statusStopListContainer = errorContainer;
