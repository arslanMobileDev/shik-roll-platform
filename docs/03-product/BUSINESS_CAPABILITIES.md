...
Полностью управляемое меню без участия разработчика и без выпуска новой версии клиентских приложений.

### Includes

- создание меню и категорий;
- Draft, Preview и Published lifecycle меню;
- публикация и снятие с публикации;
- порядок категорий и блюд;
- филиальные меню и доступность;
- Stop List;
- планирование публикации;
- история версий и Audit Log;
...
Единое управление карточками продаваемых позиций и их представлением во всех клиентских каналах.

### Includes

- стабильный идентификатор продукта;
- название, описание, состав, вес и КБЖУ;
- цены и филиальные цены;
- загрузка, замена, сортировка и безопасное удаление фотографий;
...
- модификаторы, рекомендации и сопутствующие товары;
- халяльная маркировка и аллергены;
- изменение данных без обновления приложения.
