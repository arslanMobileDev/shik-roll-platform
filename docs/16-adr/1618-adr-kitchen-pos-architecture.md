...
- `NEW/CONFIRMED -> COOKING`: атомарно записать `cookingStartedAt = serverNow`;
...
- `apps/kds/lib/features/kds/data/kds_order_models.dart`: NEW/CONFIRMED/COOKING/READY projection, version и server timestamps.
