---
Document ID: GOV-2706

Document Name: ENTERPRISE ARCHITECTURE ROADMAP
...
Определяет долгосрочную стратегию развития Enterprise Architecture SHIK Platform, устанавливая целевое архитектурное состояние, ключевые инициативы и этапы эволюции платформы.
...
GOV-2705 Technical Debt Management
