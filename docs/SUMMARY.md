...
# SHIK Platform Documentation Summary

Центральная карта документации SHIK Platform.

SUMMARY является навигационным документом, не получает Document ID, не заменяет управляемые документы и не устанавливает архитектурные решения.
...
- [ADR-1600 Architecture Decision Records Index](16-adr/1600-adr-index.md)
- [ADR-1613 Current Infrastructure Decision](16-adr/1613-adr-beget-cloud-mvp-deployment.md)
...
- [CMP-1908 Russian Personal Data & Consumer Legal Requirements](19-compliance/1908-russian-personal-data-consumer-legal-requirements.md)
...
| Product | [PB-301 Product Overview](03-product/PRODUCT_OVERVIEW.md) |
...
| Integrations | [INT-1001 Integration Overview](10-integrations/1001-integration-overview.md) |
...
| Testing & Quality Assurance | [QA-1301 Testing Overview](13-testing/1301-testing-overview.md) |
...
| Marketplace | [MKT-2501 Marketplace Overview](25-marketplace/2501-marketplace-overview.md) |
| Enterprise Operations | [OPS-2601 Enterprise Operations Overview](26-enterprise-operations/2601-enterprise-operations-overview.md) |
| Enterprise Architecture Governance | [GOV-2701 Architecture Governance Overview](27-enterprise-architecture-governance/2701-enterprise-architecture-governance-overview.md) |

---

# Compatibility Paths

The following directories are retained as compatibility navigation and are not independent canonical books:

- [Architecture compatibility index](architecture/README.md)
- [Engineering compatibility index](engineering/README.md)
- [Operations compatibility index](operations/README.md)
- [Product compatibility index](product/README.md)
- [Legacy ADR compatibility index](19-decisions/README.md)

---

# Navigation Policy

- `docs/README.md`, `docs/SUMMARY.md`, and GOV-2707 Document Registry form the mandatory central navigation layer.
- README files inside individual books are optional.
- Navigation files do not receive Document IDs unless the project owner explicitly changes the policy.
- Canonical content remains in the governed document identified by its Document ID.
